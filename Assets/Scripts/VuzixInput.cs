...
public static class VuzixInput {
	public delegate void onVuzixInput(VINPUT_EVENT pEvent);
	public static event onVuzixInput onVuzixInputEvent;
	public static void dispatchVuzixInputEvent(VINPUT_EVENT pEvent) { if(onVuzixInputEvent != null) onVuzixInputEvent(pEvent); }
	...
	public static void Update (float dt) {
			...
			_tap1F = Input.GetKeyDown(KeyCode.Space);//Input.GetMouseButtonDown(0);
		...
		if( _tap1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.TAP_1FINGER); }
		if( _tap2F ) { dispatchVuzixInputEvent( VINPUT_EVENT.TAP_2FINGER); }
		if( _swipeBackward1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_BACKWARD_1FINGER); }
		if( _swipeForward1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_FORWARD_1FINGER); }
		if( _swipeUp1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_UP_1FINGER); }
		if( _swipeDown1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_DOWN_1FINGER); }
		if( _swipeBackward2F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_BACKWARD_2FINGER); }
		if( _swipeForward2F ) { dispatchVuzixInputEvent( VINPUT_EVENT.SWIPE_FORWARD_2FINGER); }
		if( _hold1F ) { dispatchVuzixInputEvent( VINPUT_EVENT.HOLD_1FINGER); }
	}
}